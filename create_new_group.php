...
<body>
  <div class="container">
         ...
         <div class="form-group container">
         	<label for="file">Upload Group Icon:</label>

         	<input class="form-control" type="file" id="file-input" required accept="images/*">
         	<label for="group_name">Group name</label>
         	<input id="group_name" class="form-control" type="text" name="group_name" required>
         ...
         <div class="box">
         	<div class="options hide">
         		...
         		<input type="number" class="img-w" value="100" max="1200" min="100">
         	</div>
         	<button class="btn save hide">Save</button>
         	<a href="" class="btn download hide">Create</a>
         </div>
  </div>
</body>
<style type="text/css">
    ...
    var croppedx="";
	 ...
	 var password= $("#password").val();
	 		$.ajax({
	 			...
	 			type:'POST',
	 			data:{image:croppedx,groupname:groupname,password:password},
